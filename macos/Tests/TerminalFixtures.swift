...
/// An isolated daemon, and a shell that reads no startup files. Its `claude` and `codex` are stubs
...
struct DaemonFixture {
    ...
    var shell: String { directory.appendingPathComponent("fixture-shell").path }
